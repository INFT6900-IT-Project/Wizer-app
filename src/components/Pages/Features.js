...
function Features() {
  ...
  return (
    ...
    <div className='features'>
      <h1>WIZER</h1>
      <h2>we offer a comprehensive platform designed to elevate the educational and training experience
      ...
      <div className='card-container'>
        <div className='card'>
          ...
          <div className='card-content'>
            <h3>Customization</h3>
            <p>Administrators and educators can design and organize learning modules based on the users' needs</p>
        ...
        <div className='card'>
          ...
          <div className='card-content'>
            ...
            <p>Incorporates interactive elements like quizzes, videos, simulations, and real-time exercises</p>
            <a href='' class='btn' >Read more</a>
          </div>
        </div>
        ...
        <div className='card'>
          ...
          <div className='card-content'>
            <h3>Secure</h3>
            <p>Data privacy and security protocols are implemented to ensure the confidentiality of user information.</p>
            <a href='' class='btn'>Read more</a>
          </div>
        </div>
      </div>
